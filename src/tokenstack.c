...
static_assert(NUM_INTRINSICS == 9, "Exhaustive handling of intrinsics in INTRINSIC_STR_TABLE");
static const char *INTRINSIC_STR_TABLE[9] = {"abs", "sqrt", "ln", "sin", "cos", "tan", "arcsin", "arccos", "arctan"};
