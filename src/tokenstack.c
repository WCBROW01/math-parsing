...
static_assert(NUM_INTRINSICS == 15, "Exhaustive handling of intrinsics in INTRINSIC_STR_TABLE");
static const char *INTRINSIC_STR_TABLE[15] = {"abs", "sqrt", "cbrt", "ln", "sin", "cos", "tan", "asin", "acos", "atan", "atan2", "rand", "floor", "ceil", "ldexp"};
