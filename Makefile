...
calculator: build/tokenstack.o build/lexing.o build/parsing.o build/eval.o src/main.c
	$(CC) $(CC_PARAMS) -o calculator build/tokenstack.o build/lexing.o build/parsing.o build/eval.o src/main.c -lm -O2
