...
calculator: src/main.c build/lexing.o build/parsing.o build/tokenstack.o
	$(CC) $(CC_PARAMS) -o calculator src/main.c build/lexing.o build/parsing.o build/tokenstack.o -lm -O2
